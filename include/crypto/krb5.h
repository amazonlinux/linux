 ...
 * krb5_api.c
 */
DECLARE_CRYPTO_API(crypto_krb5_find_enctype, const struct krb5_enctype *,
	(u32 enctype),
	(enctype));
DECLARE_CRYPTO_API(crypto_krb5_how_much_buffer, size_t,
	(const struct krb5_enctype *krb5, enum krb5_crypto_mode mode, size_t data_size, size_t *_offset),
	(krb5, mode, data_size, _offset));
DECLARE_CRYPTO_API(crypto_krb5_how_much_data, size_t,
...
DECLARE_CRYPTO_API(crypto_krb5_where_is_the_data, void,
	(const struct krb5_enctype *krb5, enum krb5_crypto_mode mode, size_t *_offset, size_t *_len),
	(krb5, mode, _offset, _len));
DECLARE_CRYPTO_API(crypto_krb5_prepare_encryption, struct crypto_aead *,
	(const struct krb5_enctype *krb5, const struct krb5_buffer *TK, u32 usage, gfp_t gfp),
	(krb5, TK, usage, gfp));
DECLARE_CRYPTO_API(crypto_krb5_prepare_checksum, struct crypto_shash *,
	(const struct krb5_enctype *krb5, const struct krb5_buffer *TK, u32 usage, gfp_t gfp),
	(krb5, TK, usage, gfp));
DECLARE_CRYPTO_API(crypto_krb5_encrypt, ssize_t,
...
DECLARE_CRYPTO_API(crypto_krb5_decrypt, int,
...
DECLARE_CRYPTO_API(crypto_krb5_get_mic, ssize_t,
...
DECLARE_CRYPTO_API(crypto_krb5_verify_mic, int,
 ...
 * krb5_kdf.c
 */
DECLARE_CRYPTO_API(crypto_krb5_calc_PRFplus, int,
