...
DECLARE_CRYPTO_VAR(crypto_sm4_fk, const u32, [4]);
DECLARE_CRYPTO_VAR(crypto_sm4_ck, const u32, [32]);
DECLARE_CRYPTO_VAR(crypto_sm4_sbox, const u8, [256]);
 ...
 * pointer) is supplied.
 */
DECLARE_CRYPTO_API(sm4_expandkey, int,
 ...
 */
DECLARE_CRYPTO_API(sm4_crypt_block, void,
