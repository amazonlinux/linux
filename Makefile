...
crypto/fips140/fips140.o: crypto-module.a
	$(call if_changed_no_force,ld_fips140)
crypto/fips140/.fips140.order: crypto/fips140/fips140.o
	echo "crypto/fips140/fips140.o" > $@
crypto/fips140/fips140.mod: crypto-module.a
	$(call if_changed_no_force,fips140_mod)
