...
fips140-embedded.o: fips140-ready
	@echo "  LD      $@"
...
fips140-ready: modules_prepare modpost fips140.mod.c
ifneq ($(KBUILD_MODPOST_NOFINAL),1)
	$(Q)$(MAKE) -f $(srctree)/scripts/Makefile.modfinal-fips
endif

# Ensure fips140.mod.c is generated by modpost
fips140.mod.c: fips140.o modules.order
